/*
  ...
  for each graph constructors,
   there are test on the existence of node, edge, weight
   and the right dierction of the egdes, even test on some
   non-added node (incase sth wired happen).
  for method,
