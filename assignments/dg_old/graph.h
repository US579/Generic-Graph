...
public:
  ...
  typename std::vector<N>::iterator  find(const N&, const N&, const E&);
  void begin() const{ itor = 0; }
...
template <typename N,typename E>
typename std::vector<N>::iterator gdwg::Graph<N,E>::find(const N&, const N&, const E&){
